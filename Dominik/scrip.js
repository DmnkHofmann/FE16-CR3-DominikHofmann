...
var whole = (fest_day1 + fest_day2 + fest_day3)
var discount = (whole / 100 * 30)
var full = (whole - discount)
console.log(discount)
console.log(whole - discount)
console.log("If I had booked the concert with enough time in advance, it would have cost me a total of " + full + "€ and I would have saved " + discount + "€")